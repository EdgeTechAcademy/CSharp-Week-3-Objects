...
namespace Inheritance
{
    ...
    class Checking : Account
    {
        ...
        //  Checking acount specific attribute
        ...
        //  Checking object spcific method
        public void AddCheck(string checkInfo, decimal amount)
        {
            Balance -= amount;      //  we can use the Balance attribute from the parent class
            checks.Add(checkInfo + $" {amount:C}");
        }

        public void PrintCheckRegister()
        {
            //  for each check that has been cashed
